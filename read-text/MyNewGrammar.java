...
parser.Input();
  ...
  static final public void IfStatment() throws ParseException {
    jj_consume_token(If);
    CompareStatment();
  ...
  static final public void CompareStatment() throws ParseException {
  ...
  static final public void AssignStatment() throws ParseException {
    jj_consume_token(Id);
...
System.out.println("Assignment Statment is done");
  ...
  static final public void TotolResult() throws ParseException {
    Number();
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case Plus:
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x20200,0x20000,0x20000,0x400,0x20,};
   }
